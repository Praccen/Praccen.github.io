...
export { mat4, quat, vec2, vec3 } from 'gl-matrix';
...
declare class Transform {
    ...
    calculateMatrix(matrix?: mat4, identityMatrixFirst?: boolean): void;
}
...
declare class Mesh extends GraphicsObject {
...
declare class MeshStore {
    ...
    getMesh(shaderProgram: ShaderProgram, path: string, printWarnings?: boolean): Mesh;
...
export { Camera, GUIRenderer, MousePicking, PhysicsObject, PhysicsScene, Ray, Renderer, Scene, Transform, applicationStartTime, meshStore, textureStore };
